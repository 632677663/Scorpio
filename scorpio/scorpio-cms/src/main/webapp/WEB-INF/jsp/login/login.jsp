...
<meta name="description" content="Scorpio Login" />
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="login-container" style="margin-top:100px">
                        <div class="center">
                            <h1>
                                <i class="ace-icon fa fa-leaf green"></i> <span class="red">Scorpio</span>
                                <span class="red" id="id-text2">System</span>
                            </h1>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <h4 class="header blue lighter bigger">
                                            <i class="ace-icon fa fa-coffee green"></i>&nbsp;&nbsp;&nbsp;&nbsp;登陆
                                        </h4>
                                    ...
                                    <!-- <div class="toolbar clearfix">
                                        <div>
                                            <a href="#" data-target="#forgot-box"
                                                ...
                                                <i class="ace-icon fa fa-arrow-left"></i> I forgot
                                                my password
                                            </a>
                                        </div>
                    ...
                    /*jQuery(function($) {
                         ...
                         $('#btn-login-light')
                                .on(
                                        ...
                                        function(e) {
                                            $('body').attr('class',
                                                    'login-layout light-login');
                                            $('#id-text2')
                                                    .attr('class', 'grey');
                                            $('#id-company-text').attr('class',
                                                    'blue');
